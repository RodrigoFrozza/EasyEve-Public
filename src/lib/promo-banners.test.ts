...
describe('promo-banners', () => {
  ...
  describe('buildPromoBannerWriteData', () => {
    ...
    it('should throw for an EXTERNAL_LINK action with a javascript: URL', () => {
      const input = {
        title: 'Test',
        description: 'Test',
        badgeText: null,
        ...
        actionConfig: { url: 'javascript:alert(1)' },
      } as unknown as PromoBannerInput
      expect(() => buildPromoBannerWriteData(input)).toThrow()
    })

    it('should accept an EXTERNAL_LINK action with a valid https URL', () => {
      const input = {
        title: 'Test',
        description: 'Test',
        badgeText: null,
      ...
      expect(() => buildPromoBannerWriteData(input)).not.toThrow()
    })
  })
