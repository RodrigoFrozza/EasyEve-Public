...
export function miningPriceBasisTooltip(basis: MiningPriceBasis): string {
  switch (basis) {
    case 'jita_buy_raw':
      return 'Price: highest Jita buy order (raw) at Jita 4-4 / Perimeter hubs.'
    case 'jita_buy_compressed':
      return 'Price: highest Jita buy for compressed ore, converted per raw unit (100:1 except ice).'
    case 'jita_sell_raw':
      return 'Fallback: lowest Jita sell order (raw) at Jita 4-4 / Perimeter hubs — may be less representative than buy.'
