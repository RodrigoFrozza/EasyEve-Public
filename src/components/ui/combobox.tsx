...
export function StructureCombobox({
  ...
  useEffect(() => {
    ...
    const fetchStructures = async () => {
      console.log('Fetching structures for character:', characterId)
      setLoading(true)
      try {
        ...
        if (!response.ok) {
          console.error('Structures fetch failed:', response.status)
          if (!cancelled) setAllStructures([])
          return
        }
        
        const data = await response.json()
        console.log('Structures data received:', data.length, data)
...
export function ContainerCombobox({
  ...
  useEffect(() => {
    ...
    const fetchContainers = async () => {
      console.log('Fetching containers:', { characterId, structureId })
      setLoading(true)
      try {
        ...
        console.log('Container fetch URL:', `/api/characters/${characterId}/assets?${params}`)
        ...
        const data = await response.json()
        console.log('Container data received:', data.length, data)
