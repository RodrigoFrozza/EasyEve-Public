  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-eve-border bg-transparent text-eve-text hover:bg-eve-panel hover:text-eve-accent',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80',
        ghost: 'text-eve-muted hover:bg-eve-panel hover:text-eve-text',
        link: 'text-primary underline-offset-4 hover:underline',
        eve: 'bg-eve-accent text-eve-dark font-semibold hover:bg-eve-accent/85',
      },
      size: {
