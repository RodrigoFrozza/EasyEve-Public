            ...
            <>
              ...
              {activity.participants.length > 3 && (
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-11 h-10 bg-black border-zinc-800 text-[10px] font-black uppercase tracking-[0.15em] rounded-none font-outfit pr-10"
                  />
                  {searchTerm && (
                    <button
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {filteredParticipants.length === 0 ? (
                   <div className="col-span-full py-8 text-center text-zinc-500 text-[11px] font-black uppercase tracking-[0.2em]">
                    NO RESULTS FOUND
                  </div>
                ) : (
                  filteredParticipants.map((participant) => (
                    <div 
                      ...
                      className="bg-black border border-zinc-900 rounded-none p-3 flex items-center gap-3 hover:border-zinc-700 transition-all duration-300 group shadow-xl"
                    >
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <div className="relative cursor-pointer">
                            <Avatar className="h-10 w-10 border border-zinc-800 rounded-none ring-2 ring-black/40 group-hover:ring-blue-500/10 transition-all duration-300">
                            ...
                            <div className="absolute -bottom-1 -right-1 h-4 w-4 bg-black border border-zinc-800 rounded-none flex items-center justify-center shadow-2xl">
