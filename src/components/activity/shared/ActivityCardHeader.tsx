        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-500 font-outfit flex items-center gap-2">
                {t('activity.fleet')} #{String(index + 1).padStart(2, '0')} • {typeLabel}
                {activity.data?.isAutoTracked && (
                  <span className="px-1.5 py-0.5 rounded-md bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[8px] font-black tracking-widest">
                    AUTO
                  </span>
                )}
              </span>
