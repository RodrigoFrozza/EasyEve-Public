...
export function FinancialDashboard({ 
  ...
  return (
    <div className="bg-black p-4 rounded-none border border-zinc-900 space-y-4 relative overflow-hidden group/fin">

      <div className="flex items-center justify-between relative z-10">
        <div className="flex items-center gap-2">
          <div className={cn(
            "h-3 w-1 rounded-none shadow-[0_0_8px_rgba(34,197,94,0.4)]",
        ...
        <div className="pt-2 relative z-10">
           ...
           <div className="flex flex-wrap gap-2">
             {Object.entries(activity.data?.oreBreakdown || {}).slice(0, 4).map(([typeId, data]: [string, any]) => (
                <div key={typeId} className="flex items-center gap-2 px-2 py-1.5 rounded-none bg-black border border-zinc-900 group/ore hover:border-zinc-700 transition-colors">
                 <Image 
