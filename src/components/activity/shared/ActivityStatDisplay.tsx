...
export function ActivityStatDisplay({
  ...
  const formattedValue = useMemo(() => {
    ...
    if (formatAsNumber) return formatNumber(value as number)
    return value
  }, [value, formatAsISK, formatAsNumber])
    ...
    >
      ...
      <div className="flex flex-col min-w-0 flex-1 justify-center">
        <div className="flex flex-col">
          <span className={cn(
            "font-black tracking-tight font-inter transition-colors truncate leading-tight",
