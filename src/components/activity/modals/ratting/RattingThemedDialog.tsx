...
export function RattingThemedDialog({
  open,
  onOpenChange,
  badge,
  title,
  ...
  maxWidth = 'md',
  scrollable = false,
}: RattingThemedDialogProps) {
  const Icon = getActivityThemeIcon('ratting')
...
export { theme as rattingModalTheme }
