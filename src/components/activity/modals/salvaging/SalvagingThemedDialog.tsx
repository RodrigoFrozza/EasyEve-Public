...
type SalvagingThemedDialogProps = {
  open: boolean
...
export function SalvagingThemedDialog({
  open,
  onOpenChange,
  badge,
  title,
  ...
  maxWidth = 'md',
  scrollable = false,
}: SalvagingThemedDialogProps) {
  const Icon = getActivityThemeIcon('salvaging')
...
export { theme as salvagingModalTheme }
