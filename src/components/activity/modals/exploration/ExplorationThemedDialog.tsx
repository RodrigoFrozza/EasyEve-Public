...
const theme = getActivityTheme('exploration')

type ExplorationThemedDialogProps = {
  open: boolean
...
export function ExplorationThemedDialog({
  open,
  onOpenChange,
  badge,
  title,
  ...
  maxWidth = 'md',
  scrollable = false,
}: ExplorationThemedDialogProps) {
  const Icon = getActivityThemeIcon('exploration')
...
export { theme as explorationModalTheme }
