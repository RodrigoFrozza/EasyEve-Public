  ...
  if (logs.length === 0 && metrics.miningValue <= 0) {
    return (
      ...
      >
        ...
        <p className="text-zinc-500 font-black uppercase tracking-[0.5em] text-[11px] font-outfit">{t('activity.summary.noExtractionData')}</p>
      </motion.div>
    )
  }
    ...
    <div className="space-y-16">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-8 mb-12 relative z-10">
           <div className="flex items-center gap-6">
              ...
              <div>
                 <h3 className="text-[11px] font-black uppercase tracking-[0.4em] text-zinc-400 font-outfit">{t('activity.summary.consolidatedCargo')}</h3>
           ...
           <div className="bg-black/40 px-6 py-3 rounded-xl border border-white/5 backdrop-blur-md">
              <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest font-outfit">{t('activity.summary.oreTypes')}: {globalOreSummary.length}</span>
           </div>
        </div>
      ...
      <div className="space-y-8">
        <div className="flex items-center gap-6 mb-4">
           <h4 className="text-[11px] uppercase font-black tracking-[0.5em] text-zinc-700 font-outfit shrink-0">{t('activity.summary.personnelLogs')}</h4>
              ...
              >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                      ...
                      <p className="text-[11px] text-zinc-500 font-black uppercase tracking-[0.2em] font-outfit">
                        {Object.keys(group.ores).length} <span className="text-zinc-700">{t('activity.summary.protocols')}</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-center justify-between xl:justify-end gap-6">
                  <div className="text-left xl:text-right">
                    <p className="text-[10px] text-zinc-600 font-black uppercase tracking-[0.3em] font-outfit mb-1">{t('activity.summary.grossRevenue')}</p>
