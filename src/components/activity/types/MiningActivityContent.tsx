    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
        <ActivityStatDisplay
          ...
          value={formatNumber(Math.round(miningTotalQuantity))}
          subValue="m³"
          variant="default"
          size="compact"
        ...
        <ActivityStatDisplay
          ...
          value={formatNumber(Math.round(m3PerHour))}
          subValue="m³/h"
          variant="default"
          size="compact"
          valueClassName="text-white"
            ...
            <div key={ore.typeId} className="flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[8px] text-zinc-500 font-mono mt-0.5">
                  {formatNumber(ore.quantity)} {t('activity.mining.units')}
                </p>
              </div>
              <div className="text-right shrink-0">
                <p className={cn('text-[10px] font-mono font-bold leading-none', colors.text)}>{formatISK(ore.value)}</p>
                <p className="text-[8px] text-zinc-500 font-mono mt-0.5">{formatISK(ore.perUnit)}/u</p>
              </div>
            </div>
          ))
        ) : (
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="flex flex-col gap-0.5 min-w-0">
                  ...
                  <span className="text-[9px] text-zinc-500 font-bold uppercase tracking-tighter">
                    {formatNumber(quantity)} {t('activity.mining.units')} • {formatNumber(Math.round(volume))} m³
                  </span>
              ...
              <div className="flex flex-col items-end gap-1 shrink-0">
                <span className="font-mono font-black text-amber-200/90">{formatISK(value)}</span>
                <span className="text-[8px] font-mono text-zinc-500">{formatISK(perUnit)}/u</span>
