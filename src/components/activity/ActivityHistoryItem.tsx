        ...
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[1fr_auto_auto] lg:items-center relative z-10">
          <div className="min-w-0 space-y-2">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <p className={cn('font-black text-white uppercase truncate tracking-tight', isCompact ? 'text-sm' : 'text-base')}>
          ...
          <div className="p-6">
            <DialogHeader>
              ...
              <DialogDescription className="text-zinc-400 pt-4 text-xs leading-relaxed">
                Deleting this record permanently removes it from history and leaderboard calculations.
              </DialogDescription>
            </DialogHeader>
          </div>
