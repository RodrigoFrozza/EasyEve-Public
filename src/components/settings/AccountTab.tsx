    ...
    return (
      <div className="space-y-6">
        <Card className="bg-eve-panel/50 border-eve-border backdrop-blur-md">
          <CardHeader>
            <div className="h-6 w-48 bg-eve-dark rounded animate-pulse" />
            <div className="h-4 w-72 bg-eve-dark rounded animate-pulse mt-2" />
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="h-20 w-20 rounded-full bg-eve-dark animate-pulse" />
                <div>
                  <div className="h-6 w-32 bg-eve-dark rounded animate-pulse" />
                  <div className="h-4 w-24 bg-eve-dark rounded animate-pulse mt-2" />
                </div>
              </div>
              <div className="h-8 w-32 bg-eve-dark rounded animate-pulse" />
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="sm:col-span-2 h-20 bg-eve-dark rounded animate-pulse" />
              <div className="h-16 bg-eve-dark rounded animate-pulse" />
              <div className="h-16 bg-eve-dark rounded animate-pulse" />
            </div>
          </CardContent>
        </Card>
