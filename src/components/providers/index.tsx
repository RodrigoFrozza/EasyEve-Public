...
import { ThemeProvider, type AccentColor } from './theme-provider'
      ...
      new QueryClient({
        defaultOptions: {
          queries: {
            ...
            gcTime: 5 * 60 * 1000, // 5 minutes (v5 rename of cacheTime)
            retry: 1,
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <I18nProviderWrapper initialLocale={initialLocale}>
        <ThemeProvider initialAccentColor={initialAccentColor}>
